...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
        ...
        <div class="flex items-center gap-3 px-6 py-5 border-b border-gray-700">
            ...
            <div>
                <p class="font-bold text-white leading-none">BukuKating</p>
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('admin.users.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition text-sm
                      {{ request()->routeIs('admin.users.index') || request()->routeIs('admin.users.create') || request()->routeIs('admin.users.edit') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
